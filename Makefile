...
#ifeq ($(RADIO_TYPE), PRX)
#	SRCDIRS += ./app/src/receiver ./gazell/host ./app/src/telemetry ./app/src/host_addr
#else
...
INCDIRS  = -I./freertos/inc \
           -I./drivers/CMSIS/inc \
           -I./drivers/STM32F2xx_StdPeriph_Driver/Inc \
           -I./app/inc \
...
%.elf:$(OBJS)
	$(CC) $(OBJS) -mcpu=cortex-m3 -mthumb -lm -L./script/ -T$(LDSCRIPT) $(LDFLAGS) -o $@
